    ...
    if (!token) {
        return (
            <div className="w-full max-w-md space-y-6 rounded-2xl glass p-8 shadow-2xl text-center">
                ...
                <h2 className="text-2xl font-bold tracking-tight text-text">Invalid Reset Link</h2>
    ...
    return (
        <div className="w-full max-w-md space-y-8 rounded-2xl glass p-8 shadow-2xl">
            <div className="text-center">
                <h2 className="text-3xl font-bold tracking-tight text-text">Set new password</h2>
            ...
            {success ? (
                <div className="space-y-6 text-center">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-lg font-semibold text-text">Password reset successful!</h3>
                        <p className="text-sm text-text-secondary">
