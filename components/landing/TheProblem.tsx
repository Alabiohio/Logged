...
export default function TheProblem() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <div className="rounded-[40px] border border-border/60 bg-glass/60 p-8 backdrop-blur-2xl sm:p-12 lg:p-16">
        ...
        >
          <p className="inline-block rounded-full bg-primary/10 px-6 py-2.5 text-base font-semibold text-primary">
