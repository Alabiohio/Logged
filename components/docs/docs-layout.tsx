  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="flex min-w-0 w-full overflow-x-hidden">
        {/* Desktop sidebar */}
        <aside className="hidden w-72 shrink-0 border-r border-border bg-background-secondary/70 backdrop-blur-xl lg:flex lg:flex-col">
                        ...
                        return (
                          <li key={item.name}>
                            <Link
                              ...
                              className={`group flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium transition ${isActive
        ...
        {/* Mobile sidebar */}
        <aside
          className={`fixed inset-y-0 left-0 z-50 w-72 shrink-0 border-r border-border bg-background-secondary/70 backdrop-blur-xl transform transition-transform duration-200 ease-out lg:hidden ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}
        >
        ...
        <main className="flex-1 min-w-0 w-full overflow-x-hidden">
          <div className="max-w-4xl min-w-0 w-full mx-auto px-4 py-8 sm:px-6 lg:px-8">
            {children}
          </div>
        </main>
      </div>
